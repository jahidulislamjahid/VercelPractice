...
// CONNECTION URI
const uri = `mongodb+srv://${process.env.DB_USER}:${process.env.DB_PASS}@cluster0.qtoag.mongodb.net/timetracer?retryWrites=true&w=majority`;
console.log(uri);
...
async function run() {
  try {
    ...
    const database = client.db("timetracer");
